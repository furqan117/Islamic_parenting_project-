        ...
        <div className='flex flex-col md:flex-row items-center md:items-start mb-8'>
          <div className='md:w-1/2 mb-8 md:mb-0 md:mr-8'>
            ...
            <p className='text-lg mt-4 text-[1.5rem] font-semibold  '>
              At Al-Hikma, we provide a wealth of resources, including articles, tips, and practical advice on various aspects of parenting. Our content is rooted in the teachings of the Quran and the Sunnah, and we strive to present it in a way that is relevant and accessible to today's parents.
              
               adolescent challenges, or fostering a strong family bond, we are here to support you every step of the way. Join us in our mission to create a nurturing and positive environment for our children, and together, let's pave the way for a brighter future for our Ummah.
            </p>
          </div>
